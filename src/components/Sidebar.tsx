...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, onSelectTab }) => {
  ...
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '0 12px 16px 12px' }}>
        <img src={'/Gemini_Generated_Image_o5ngkwo5ngkwo5ng-removebg-preview.png'} alt="logo" className="logo logo--sidebar" />
        <h2 style={{ fontSize: '20px', fontWeight: 800, margin: 0, color: '#e58e26' }}>ChessCraft</h2>
      </div>
